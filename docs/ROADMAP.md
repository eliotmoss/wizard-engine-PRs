...
**Audited 2026-08-31:** the eleven implementation-specific x86-64 Linux test files contain **236 registered tests**. All 236 pass with no unexpected failures (the full unit binary contains 1,947 tests including portable and spec-parser coverage; its only 7 failures are the pre-existing entries in `test/unittest.failures.x86-64-linux`).
