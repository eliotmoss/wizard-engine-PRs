...
**Audited 2026-07-31 and extended 2026-08-11:** the five implementation-specific x86-64 Linux test files contain **142 registered tests**. The previous 140-test audit passed in an amd64 Docker container on a Darwin arm64 host; all 142 pass with no expected failures in the latest native x86-64 Linux run.
