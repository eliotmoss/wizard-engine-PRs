...
**Audited 2026-07-31 and extended 2026-08-06:** the five implementation-specific x86-64 Linux test files contain **140 registered tests**. All 140 pass with no expected failures when the x86-64 Linux unit binary is run in an amd64 Docker container on the current Darwin arm64 host.
